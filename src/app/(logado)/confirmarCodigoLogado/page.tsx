            ...
            <section>
                <div className="flex flex-col justify-center items-center mt-[10%] gap-4 md:mt-[5%]">
                    ...
                    <div className="mt-3 w-[55%] md:w-[50%] lg:w-[50%]">
                            <BotaoGrande title="Reenviar código" background="terciaria" type="button"/>
                        </div>
                        <div className="mt-3 w-[40%] md:w-[50%] lg:w-[50%]">
                            <BotaoGrande title="Continuar" background="secundaria" type="button" onClick={() => push('/redefinirSenhaLogado')}/>
                        </div>
                    </div>
                </div>
            </section>
