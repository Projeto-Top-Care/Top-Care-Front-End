...
export default function MeusPets({ usuario, setOpenPet }: iPedidos) {
    ...
    return (
        <main className="w-full">
            <section className="grid lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 md:mb-12 mb-4 md:w-[90%] w-full lg:pl-20 md:pl-12 md:p-0 lg:self-start self-center gap-8 p-5">
                {
