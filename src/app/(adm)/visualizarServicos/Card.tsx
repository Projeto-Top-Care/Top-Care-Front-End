...
export default function Card({ src, servico }: CardProps) {
  ...
  return (
    <div className='text-preto duration-100 hover:scale-105 flex flex-col w-full h-44 md:h-72 border mb-4 border-preto rounded-xl cursor-pointer' onClick={()=>router.push(`/editarServicos?id=${servico.id}`)}>
