...
export default function Checkbox({ check, onClick}: IChecked) {
    ...
    return (
        <div className='flex items-center justify-center mr-2'>
            <input type="checkbox" name="" id="checkbox" className='peer appearance-none w-4 h-4 border bg-cinza-claro rounded checked:border-0 checked:bg-secundaria' checked={checked} onChange={() => setChecked(!checked)} onClick={onClick}/>
